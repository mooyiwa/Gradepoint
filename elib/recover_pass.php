           	       ...
           	       <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" class="form pushdown">
                            ...
                            <table>
                                     ...
                                     if(isset($_POST['recover']))
                                         ...
                                         $secret = $_POST['secret'];
                                         $answer = $_POST['answer'];
                                         $sql ="select username,email,secret,answer from elib_users where email = '$email' AND secret = '$secret' AND answer = '$answer'";
                                         ...
                                         if(mysqli_num_rows($result) > 0){
                                             ...
                                             $insql = "update elib_users set password1 = md5('$pass'),
                                                                          password2 = md5('$pass')
                                                                          where username = '$user'"; 
